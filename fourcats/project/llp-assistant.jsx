  ...
  if (kind === "food")
    return {
      ...
      flag: {
        ...
        body: "Chicken + lentils may aggravate sensitive skin. Consider salmon-based LID food.",
      },
      sources: [
        {
          src: "Kohepets Catalogue",
          icon: "inventory_2",
          title: "Acana Adult — Ingredients",
          body: "Chicken, chicken meal, red lentils, pinto beans, whole green peas…",
        },
        {
          src: "Vet Knowledge Base",
          icon: "medical_information",
          title: "Sensitive skin diet guidance",
          body: "Limited-ingredient, novel-protein diets reduce flare-ups in humid climates.",
        },
      ],
    };
  if (kind === "vet")
    return {
      ...
      card: {
        name: "The Animal Clinic — " + pet.area,
        sub: "Strong reviews for derm & allergy work.",
        rating: "4.7",
        chips: [
          ["HDB-Approved", "green"],
          ["1.2 km", "neutral"],
      ...
      sources: [
        {
          src: "Google Maps API",
          icon: "map",
          title: "The Animal Clinic reviews",
          body: '"Dr Tan was thorough with our pup\'s skin allergy — clear treatment plan."',
        },
        {
          src: "Review Sentiment",
          icon: "reviews",
          title: "Derm sentiment: 92% positive",
          body: "Owners praise allergy diagnosis & follow-up care.",
        },
      ],
    };
  return {
    ...
    card: {
      name: "Heartland Paws " + pet.area,
      sub: "Medicated baths & hypoallergenic styling.",
      rating: "4.8",
      chips: [
        ["HDB-Approved", "green"],
        ["1.2 km", "neutral"],
    ...
    sources: [
      {
        ...
        body: '"Wonderful with my sensitive pup — used a medicated shampoo that didn\'t irritate her skin at all."',
      },
      {
        src: "Pet Lovers Centre",
        icon: "storefront",
        title: "Oatmeal Medicated Shampoo",
        body: "Recommended for sensitive skin. Eases itching common in humid SG climates.",
      },
    ],
  };
}
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div
          style={{ fontSize: 13, color: "var(--ink-2)", margin: "3px 0 7px" }}
        >
          {card.sub}
        </div>
      ...
      >
        <div
          style={{
            ...
            fontSize: 14.5,
            lineHeight: 1.5,
            boxShadow: "0 8px 18px rgba(120,35,56,.18)",
          }}
        >
          {m.text}
        </div>
      ...
      <div style={{ maxWidth: "82%" }}>
        <div
          style={{
            ...
            background:
              "color-mix(in srgb, var(--surface) 78%, var(--primary-container))",
            border: "1px solid var(--outline)",
            color: "var(--ink)",
            fontSize: 14.5,
            lineHeight: 1.55,
          ...
          {m.flag && !m.typing && (
            ...
            >
              <Icon
                ...
                size={20}
                fill
                style={{ color: "var(--secondary)", flex: "0 0 auto" }}
              />
              <div>
                <div
                  style={{
        ...
        {m.follow && !m.typing && (
          ...
          >
            {m.follow.map((f) => (
              <Chip key={f} tone="pink" style={{ cursor: "pointer" }}>
                {f}
              </Chip>
            ))}
          </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "20px 18px" }}>
        ...
        >
          Grounded in Singapore-specific data, filtered for this pet.
        </p>
        {sources.length === 0 && (
          <div
            style={{
          ...
          >
            ...
            <div style={{ fontSize: 13 }}>
              Ask a question — I'll show exactly which local sources I used.
            </div>
          </div>
        )}
...
function Assistant({ active }) {
  ...
  const [msgs, setMsgs] = useState([
    {
      role: "ai",
      text: `Hi! How is ${active.name} doing today? I can help with grooming, health, diet or local services for your ${SPECIES_LABEL[active.species]}.`,
    },
  ]);
  ...
  useEffect(() => {
    // reset greeting when pet changes
    setMsgs([
      {
        role: "ai",
        text: `Hi! How is ${active.name} doing today? I can help with grooming, health, diet or local services for your ${SPECIES_LABEL[active.species]}.`,
  ...
  const send = (text, kind) => {
    ...
    const k =
      kind ||
      (/(food|acana|safe|eat|kibble)/i.test(text)
        ? "food"
        : /(vet|scratch|itch|sick)/i.test(text)
          ? "vet"
          : "groomer");
  ...
  return (
    <div style={{ display: "flex", height: "100%", minHeight: 0 }}>
      ...
      >
        <div
          ref={scroller}
          style={{ flex: 1, overflow: "auto", padding: "26px 30px" }}
        >
          <div
            style={{
              maxWidth: 720,
        ...
        <div
          style={{
            padding: vp.isPhone ? "12px 16px 18px" : "14px 30px 22px",
          ...
          >
            ...
            <input
              ...
              placeholder={
                vp.isPhone
                  ...
                  : `Ask about ${active.name}'s health, diet, or local services…`
              }
              style={{
                flex: 1,
                minWidth: 0,
            ...
            >
              <Icon
                ...
                size={20}
                fill
                style={{ color: busy ? "var(--ink-3)" : "#fff" }}
              />
            </button>
          </div>
        </div>
      ...
      {!vp.isTablet && (
        <ContextPanel sources={sources} onGrip={onGrip} width={pw} />
      )}
      {vp.isTablet && drawer && (
        <div
