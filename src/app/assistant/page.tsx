import { Bot, Info, Map as MapIcon, Mic, SendHorizontal, ShoppingBag, Star, UserRound } from "lucide-react";
    ...
    return (
        <section className="relative flex min-h-[calc(100vh-4rem)] flex-col overflow-hidden bg-[radial-gradient(#dac0c3_1px,transparent_1px)] [background-size:34px_34px]">
            <div className="mx-auto flex w-full max-w-4xl flex-1 flex-col gap-10 px-5 py-8 md:px-10">
                <div className="mx-auto rounded-full bg-[#edeeef] px-5 py-2 text-sm text-[#554244]">Today</div>
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div className="max-w-2xl rounded-2xl bg-white/90 p-6 text-xl leading-8 shadow-[0_4px_20px_rgba(29,53,87,0.05)] backdrop-blur">
                        Hi there! How is Mochi doing today? I'm ready to help with any grooming, health, or lifestyle questions you have for your Shih
                        Tzu.
                    </div>
                </div>
            ...
            <div className="sticky bottom-0 bg-gradient-to-t from-[#f8f9fa] via-[#f8f9fa] p-5 md:px-10">
                <div className="mx-auto flex max-w-4xl items-center gap-4 rounded-full border border-[#dac0c3]/70 bg-white px-5 py-3 shadow-[0_12px_28px_rgba(29,53,87,0.14)]">
                    ...
                    <span className="flex-1 truncate text-[#887274]">Ask about Mochi's health, diet, or local services...</span>
    ...
    return (
        <div className="flex items-start gap-4">
            ...
            <div className="max-w-2xl rounded-2xl bg-white/90 p-7 text-xl leading-8 shadow-[0_4px_20px_rgba(29,53,87,0.05)] backdrop-blur">
                <p>
                    Based on Mochi's profile, sensitive skin requires special care. I've found a highly-rated groomer in Tampines that specializes in
                    dermatological needs.
                </p>
                <div className="my-5 flex gap-4 rounded-xl border border-[#dac0c3]/60 bg-[#f8f9fa] p-4 text-base leading-6">
                    <img alt="Heartland Paws Tampines" className="size-20 rounded-lg object-cover" src={groomerInterior} />
                    <div className="flex-1">
                        ...
                        <p className="text-[#554244]">Specializes in medicated baths & hypoallergenic styling.</p>
                        <div className="mt-2 flex flex-wrap gap-2">
                            <Pill className="bg-[#ffdf9b]/70 text-[#785a00]">HDB-Approved</Pill>
                            <Pill className="bg-[#edeeef] text-[#554244]">1.2km away</Pill>
                        </div>
                    </div>
                </div>
                <p>
                    They use an oatmeal-based medicated shampoo which is perfect for Shih Tzus with sensitive skin. Would you like me to check their
                    availability for this weekend?
                </p>
                <div className="mt-5 flex flex-wrap gap-2">
                    {["Yes, check Saturday", "Show other options", "Call them"].map((action) => (
                        <button
    ...
    const sources = [
        {
            ...
            detail: '"Absolutely wonderful with my sensitive pup. They used a special medicated shampoo that didn\'t irritate her skin at all...."',
            icon: MapIcon,
        },
        {
            source: "Pet Lovers Centre Data",
            title: "Oatmeal Medicated Shampoo",
            detail: "Recommended for Shih Tzus (Age 3+). Alleviates itching and environmental allergies common in humid Singaporean climates.",
            icon: ShoppingBag,
        },
    ];
        ...
        <aside className="hidden border-l border-[#dac0c3]/40 bg-white px-8 py-8 lg:block">
            ...
            <div className="grid gap-4">
                {sources.map(({ source, title, detail, icon: Icon }) => (
                    <div className="rounded-2xl border border-[#dac0c3]/70 bg-[#f8f9fa] p-4" key={title}>
